...
"""Legacy log aggregation and analysis utilities for Tent of Trials. The module collects logs from multiple formats and produces JSON, CSV, or HTML reports for offline analysis."""
