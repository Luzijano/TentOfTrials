...
"""Performance benchmarking utilities for Tent of Trials services. The module measures latency, throughput, stress, soak, and spike behavior for API endpoints."""
