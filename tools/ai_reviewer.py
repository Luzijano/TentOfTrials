...
"""Automated code review reporting utilities for Tent of Trials. The module evaluates source files for maintainability, security markers, style issues, and summary metrics."""
