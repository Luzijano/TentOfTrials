...
"""Terraform state import utilities for legacy infrastructure management. The module discovers resources, plans imports, and updates Terraform state for environments without Terraform Cloud coverage."""
