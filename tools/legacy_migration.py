...
"""Legacy data migration utilities for Tent of Trials. The module supports older schema migration, validation, rollback, and dry-run workflows that are not covered by the newer migration tooling."""
